...
namespace LunarVeilLegacy.Items.Consumables
{
    internal class TreasureBoxTrap : ModItem
    {
        ...
        public override void RightClick(Player player)
        {
            ...
            {
                player.QuickSpawnItem(entitySource, ItemID.SoulofNight, Main.rand.Next(1, 7));
            }
            if (Main.rand.NextBool(1))
            {
            ...
            if (Main.rand.NextBool(1))
            {
                player.QuickSpawnItem(entitySource, ItemID.AdamantiteBar, Main.rand.Next(1, 5));
            }
            if (Main.rand.NextBool(1))
            {
            ...
            if (Main.rand.NextBool(1))
            {
                player.QuickSpawnItem(entitySource, ModContent.ItemType<KaleidoscopicInk>(), Main.rand.Next(1, 15));
            }
