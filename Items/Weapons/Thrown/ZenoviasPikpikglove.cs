...
using LunarVeilLegacy.Projectiles.Pikmin;
...
namespace LunarVeilLegacy.Items.Weapons.Thrown
{
    public class ZenoviasPikpikGlove : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
            ...
            {
                case 0:
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/Pikminthrow1") with { Volume=0.5f}, position);
                    break;

                case 1:
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/Pikminthrow2") with { Volume = 0.4f }, position);
                    break;

                case 2:
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/Pikminthrow3") with { Volume = 0.4f }, position);
                    break;

                case 3:
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/Pikminthrow4") with { Volume = 0.4f }, position);
                    break;
