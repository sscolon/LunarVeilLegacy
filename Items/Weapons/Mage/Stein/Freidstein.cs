...
using LunarVeilLegacy.Projectiles.Steins;
...
{
	public class Friedstein : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<FriedFist>();
			Item.shootSpeed = 20f;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<WanderingFlame>(), 30);
