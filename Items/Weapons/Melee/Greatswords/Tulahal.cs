...
using System.IO;
using LunarVeilLegacy.Projectiles.Slashers.Dula;
...
namespace LunarVeilLegacy.Items.Weapons.Melee.Greatswords
{
    public class Tulahal : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/RekShockwave") { Pitch = Main.rand.NextFloat(-10f, 10f) }, player.Center);
