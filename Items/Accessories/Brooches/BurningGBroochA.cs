...
namespace LunarVeilLegacy.Items.Accessories.Brooches
{
    public class BurningGBroochA : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
			...
			line = new TooltipLine(Mod, "Brooch of the TaGoa",  Helpers.LangText.Common("AdvancedBrooch"))
			{
				OverrideColor = new Color(254, 128, 10)
			};

			tooltips.Add(line);
			line = new TooltipLine(Mod, "Brooch of the TaGoa",  Helpers.LangText.Common("AdvancedBackpack"))
			{
