...
{
	public class VillagersBroochA : ModItem
	{
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			var line = new TooltipLine(Mod, "Brooch of the TaGoaadaa",  Helpers.LangText.Common("AdvancedBrooch"))
			{
				OverrideColor = new Color(254, 128, 10)
			};

			tooltips.Add(line);
			line = new TooltipLine(Mod, "Brooch of the TaGoaadaa",  Helpers.LangText.Common("AdvancedBackpack"))
			{
		...
		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			...
			broochPlayer.hasVillagersBrooch = true;
		}
