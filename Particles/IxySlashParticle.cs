...
namespace LunarVeilLegacy.Particles
{
    public class IxySlash : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            {
                spriteBatch.Draw(tex4, Center - Main.screenPosition, tex4.AnimationFrame(ref frameCount, ref frameTick, 1, 16, true), color, velocity.ToRotation() + 180, new Vector2(133f, 133f) * 0.5f, 3f * Scale, spriteEffects, 0f);


            }
            else
            {
                spriteBatch.Draw(tex3, Center - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 1, 16, true), color, velocity.ToRotation() + 180, new Vector2(133f, 133f) * 0.5f, 3f * Scale, spriteEffects, 0f);
