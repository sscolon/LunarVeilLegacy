...
{
    public class ChromaSlash : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex3 = Request<Texture2D>("LunarVeilLegacy/Particles/ChromaSlash").Value;
            Texture2D tex4 = Request<Texture2D>("LunarVeilLegacy/Particles/ChromaSlashOpp").Value;
            ...
            {
                spriteBatch.Draw(tex4, Center - Main.screenPosition, tex4.AnimationFrame(ref frameCount, ref frameTick, 1, 7, true), color, velocity.ToRotation() + 180, new Vector2(150f, 150f) * 0.5f, 2f * Scale, spriteEffects, 0f);


            }
            else
            {
                spriteBatch.Draw(tex3, Center - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 1, 7, true), color, velocity.ToRotation() + 180, new Vector2(150f, 150f) * 0.5f, 2f * Scale, spriteEffects, 0f);
