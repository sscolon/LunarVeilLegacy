...
{
    internal class YellowPikminThrow : ModProjectile
    {
        ...
        {
            return Color.Lerp(Color.Yellow * 0.1f, Color.Transparent, completionRatio);
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity + new Vector2(0.001f, 0.001f),
                ModContent.ProjectileType<YellowPikminAttack>(), Projectile.damage, Projectile.knockBack, Projectile.owner, ai0: targetNpc);
        }
