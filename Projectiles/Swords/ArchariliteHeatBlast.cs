    ...
    internal class ArchariliteRaysWave : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Moved && Projectile.ai[1] >= 0)
            {
                ...
                for (int j = 0; j < 10; j++)
                {
                    ...
                    int num8 = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.CopperCoin, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 20; i++)
            {
                ...
                int num = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CopperCoin, 0f, -2f, 0, default(Color), .8f);
