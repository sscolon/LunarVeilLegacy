...
{
    public class CBCustomSwingProjectile : ModProjectile
	{
        private bool _init;
        public override string Texture => "LunarVeilLegacy/Items/Weapons/Melee/CinderBraker";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex = ModContent.Request<Texture2D>("LunarVeilLegacy/Effects/Primitives/Trails/BulbTrail").Value;
            ...
            if (SwordSlash == null)
            {
                SwordSlash = new TrailRenderer(TrailTex, TrailRenderer.DefaultPass, (p) => new Vector2(50f), (p) => new Color(255, 155, 241, 50) * (1f - p));
