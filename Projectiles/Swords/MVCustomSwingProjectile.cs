...
{
    public class MVCustomSwingProjectile : ModProjectile
    {
        private bool _init;
        public override string Texture => "LunarVeilLegacy/Items/Weapons/Melee/MorrowValswa";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (SwordSlash == null)
            {
                SwordSlash = new TrailRenderer(TrailTex, TrailRenderer.DefaultPass, (p) => new Vector2(50f), (p) => new Color(255, 155, 20, 50) * (1f - p));
