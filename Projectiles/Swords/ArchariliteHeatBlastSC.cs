    ...
    internal class ArchariliteHeatBlastSC : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 20; i++)
            {
                ...
                int num1 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Electric, 0f, -2f, 0, default(Color), .8f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                int dustnumber = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Electric, 0f, 0f, 150, Color.MediumPurple, 1f);
