...
{
    public class FrostSwProj3 : ModProjectile
	{
		int timer = 0;
		bool launch = false;
		...
		public override void AI()
		{
			...
			{
				Projectile.rotation += 0.1f;
				int num622 = Dust.NewDust(new Vector2(Projectile.position.X - Projectile.velocity.X, Projectile.position.Y - Projectile.velocity.Y), Projectile.width, Projectile.height, DustID.BlueCrystalShard, 0f, 0f, 100, default, 2f);
				Main.dust[num622].noGravity = true;
				Main.dust[num622].scale = 1.5f;
