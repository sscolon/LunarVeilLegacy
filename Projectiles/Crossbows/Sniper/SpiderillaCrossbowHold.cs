...
{
    public class SpiderillaCrossbowHold : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Timer == 1)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ModContent.ProjectileType<AltaCircle>(), Projectile.damage * 1, 0f, Projectile.owner, 0f, 0f);
			}
			...
			if (Timer >= 100)
            {
				float speedX = Projectile.velocity.X * 10;
				float speedY = Projectile.velocity.Y * 7;
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedX * 2, speedY, ModContent.ProjectileType<SpiderillaCrossbowBolt>(), Projectile.damage * 5, 0f, Projectile.owner, 0f, 0f);
			}
