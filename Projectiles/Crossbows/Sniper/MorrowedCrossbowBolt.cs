...
namespace LunarVeilLegacy.Projectiles.Crossbows.Sniper
{
    public class MorrowedCrossbowBolt : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ProjectileID.Spark, (int)(Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
			Projectile.Kill();
		}
