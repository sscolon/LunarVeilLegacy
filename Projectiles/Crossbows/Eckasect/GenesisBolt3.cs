...
{
	public class GenesisBolt3 : ModProjectile
	{
		...
		public override void PostDraw(Color lightColor)
		{
			...
			float num106 = 0f;
			Color color1 = Color.PaleVioletRed * num107 * .8f;
			...
			Color color29 = new Color(127 - Projectile.alpha, 127 - Projectile.alpha, 127 - Projectile.alpha, 0).MultiplyRGBA(Color.PaleVioletRed);
		...
		{
			Lighting.AddLight(Projectile.Center, Color.PaleVioletRed.ToVector3() * 2.25f * Main.essScale);
			return true;
		}
