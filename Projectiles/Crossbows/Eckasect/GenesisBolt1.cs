...
using LunarVeilLegacy.NPCs.Harvesting.Morrow;
...
{
	public class GenesisBolt1 : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedXa, Projectile.position.Y + speedYa, speedXa * 0, speedYa * 0, ModContent.ProjectileType<GenesisBoom2>(), (int)(Projectile.damage * 1.5), 0f, Projectile.owner, 0f, 0f);
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			SoundEngine.PlaySound(new SoundStyle($"LunarVeilLegacy/Assets/Sounds/Starexplosion"), Projectile.position);
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX * 0, speedY * 0, ModContent.ProjectileType<GenesisBoom2>(), (int)(Projectile.damage * 1.5), 0f, Projectile.owner, 0f, 0f);
			Projectile.Kill();
			return false;
		}
        ...
        {
			Lighting.AddLight(Projectile.Center, Color.Green.ToVector3() * 2.25f * Main.essScale);
			return true;
		}
