...
namespace LunarVeilLegacy.Projectiles.Crossbows.Ultras
{
    public class MoltenCrossbowBolt : ModProjectile
	{
		...
		{
			int moredust = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.CoralTorch, 0f, 0f);
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ProjectileID.MolotovFire2, (int)(Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
			Projectile.Kill();
		}
