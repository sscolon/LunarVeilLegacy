...
namespace LunarVeilLegacy.Projectiles.Crossbows.Ultras
{
    public class CoralCrossbowBolt : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ProjectileID.Bubble, (int)(Projectile.damage * 0.3), 0f, Projectile.owner, 0f, 0f);
			Projectile.Kill();
		}
