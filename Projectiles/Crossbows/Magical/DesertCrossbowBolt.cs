...
{
    public class DesertCrossbowBolt : ModProjectile
    {
...

        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedX * 1, speedY * 1, ProjectileID.ThunderSpearShot, Projectile.damage * 2, 0f, Projectile.owner, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedX * 1, speedY * 1, ProjectileID.BookStaffShot, Projectile.damage * 2, 0f, Projectile.owner, 0f, 0f);
        }
