...
{
    public class MeatBullet3 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Timer == 2)
            {
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedXabc, Projectile.position.Y + speedYabc, speedXabc * 0, speedYabc * 0, ModContent.ProjectileType<Meatball3>(), Projectile.damage * 1, 0f, Projectile.owner, 0f, 0f);
				Timer = 0;
