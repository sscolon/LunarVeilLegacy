...
namespace LunarVeilLegacy.Projectiles.Magic
{
    public class Stardom2 : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Lighting.AddLight(Projectile.Center, Color.Violet.ToVector3() * 1.0f * Main.essScale);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int r = 0; r < 37; r++)
            {
                ...
                ParticleManager.NewParticle(Projectile.Center, speed2 * 12, ParticleManager.NewInstance<BurnParticle3>(), Color.Aqua, Main.rand.NextFloat(0.2f, 0.8f));
            ...
            for (int r = 0; r < 37; r++)
            {
                ...
                Vector2 speed2 = Main.rand.NextVector2CircularEdge(0.5f, 0.5f);
                ParticleManager.NewParticle(Projectile.Center, speed2 * 12, ParticleManager.NewInstance<BurnParticle4>(), Color.Aqua, Main.rand.NextFloat(0.2f, 0.8f));
            ...
            for (int i = 0; i < 130; i++)
            {
                ...
                var d = Dust.NewDustPerfect(Projectile.Center, DustID.OrangeTorch, speed * 15, Scale: 1f);
                ;
                d.noGravity = true;
            }
