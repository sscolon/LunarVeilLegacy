...
{
    public class DreadFireBombG : ModNPC
    {
        public float VEL = 1;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            for (float i = 0f; i < 1f; i += 0.25f)
            {
                ...
                spriteBatch.Draw(texture, DrawPos + new Vector2(0f, 5 / 2).RotatedBy(radians) * time, NPC.frame, new Color(99, 39, 51, 0), 0, frameOrigin, NPC.scale, Effects, 0);
            }
            ...
            for (float i = 0f; i < 1f; i += 0.34f)
            {
                ...
                spriteBatch.Draw(texture, DrawPos + new Vector2(0f, 5).RotatedBy(radians) * time, NPC.frame, new Color(255, 8, 55, 0), 0, frameOrigin, NPC.scale, Effects, 0);
            }
