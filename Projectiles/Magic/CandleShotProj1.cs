    ...
    internal class CandleShotProj1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] <= 1)
            {
                ...
                if (Sound == 1)
                {
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/Upp"), Projectile.position);
                }
                else
                {
                    SoundEngine.PlaySound(new SoundStyle("LunarVeilLegacy/Assets/Sounds/flameup"), Projectile.position);
                }
            }
