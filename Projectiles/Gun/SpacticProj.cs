...
{
    public class SpacticProj : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (int k = 0; k < Projectile.oldPos.Length; k++)
			{
				...
				Color color = Projectile.GetAlpha(Color.Lerp(new Color(108, 66, 255), new Color(67, 37, 172), 1f / Projectile.oldPos.Length * k) * (1f - 1f / Projectile.oldPos.Length * k));
