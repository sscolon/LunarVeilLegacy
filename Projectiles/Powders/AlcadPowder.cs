    ...
    public class AlcadPowder : ModProjectile
	{
        ...
        public override void AI()
        {
			...
			for (int j = 0; j < 10; j++)
			{
				...
				ParticleManager.NewParticle(Projectile.Center, speed * 3, ParticleManager.NewInstance<FlameParticle>(), Color.RosyBrown, Main.rand.NextFloat(0.2f, 0.8f));
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			target.AddBuff(ModContent.BuffType<AlcadDust>(), 720);
