...
{
    public class CrystalPowderProj : ModProjectile
	{
        ...
        public override void AI()
        {
			...
			for (int j = 0; j < 3; j++)
			{
				...
				ParticleManager.NewParticle(Projectile.Center, speed * 5, ParticleManager.NewInstance<ArcanalParticle2>(), Color.RosyBrown, Main.rand.NextFloat(0.2f, 0.8f));
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			target.AddBuff(ModContent.BuffType<CrystalDust>(), 720);
