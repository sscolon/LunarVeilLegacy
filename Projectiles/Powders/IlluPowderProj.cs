...
{
	public class IlluPowderProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			for (int j = 0; j < 1; j++)
			{
				...
				ParticleManager.NewParticle(Projectile.Center, speed * 4, ParticleManager.NewInstance<CrystalParticle1>(), Color.RosyBrown, Main.rand.NextFloat(0.2f, 0.8f));
		...
		public override bool PreAI()
		{
			...
			int dust2 = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.BlueTorch, 0f, 0f);
