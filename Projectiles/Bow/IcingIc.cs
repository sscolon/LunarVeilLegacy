...
namespace LunarVeilLegacy.Projectiles.Bow
{
    internal class IcingIc : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Moved && Projectile.ai[1] >= 0)
            {
                ...
                for (int j = 0; j < 10; j++)
                {
                    ...
                    int num8 = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.IceTorch, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(5f * 1), (int)(45f * 1), (int)(85f * 1), 0), Projectile.rotation, new Vector2(32, 32), 0.17f * (7 + 0.6f), SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(5f * 1), (int)(45f * 1), (int)(85f * 1), 0), Projectile.rotation, new Vector2(32, 32), 0.17f * (7 + 0.6f), SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(5f * 1), (int)(45f * 1), (int)(85f * 1), 0), Projectile.rotation, new Vector2(32, 32), 0.07f * (7 + 0.6f), SpriteEffects.None, 0f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                int num = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IceTorch, 0f, -2f, 0, default(Color), 1.5f);
