...
namespace LunarVeilLegacy.Projectiles.Slashers.Ixy
{
    public class IxyProj2 : ModProjectile
    {
        public float holdOffset = 30f;
        private bool ParticleSpawned;
        private int SwingTime => (int)((30) / Owner.GetAttackSpeed(DamageClass.Magic));
        ...
        {
            return new Color(255, 215, 70, 0) * (1f - Projectile.alpha / 255f);
        }
    }
}