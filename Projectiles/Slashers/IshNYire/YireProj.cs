    ...
    public class YireProj : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                Color color = Projectile.GetAlpha(Color.Lerp(new Color(45, 100, 104), new Color(59, 72, 168), 1f / Projectile.oldPos.Length * k) * (1f - 1f / Projectile.oldPos.Length * k / 0.2f));
