...
{
    public class Flameball : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Timer == 2)
			{
				...
				for (int j = 0; j < 1; j++)
				{
					...
					ParticleManager.NewParticle(Projectile.Center, speed2, ParticleManager.NewInstance<HeatwaveTrailParticle>(), Color.Violet, Main.rand.NextFloat(0.2f, 0.8f));
				}
				Timer = 0;
			}
