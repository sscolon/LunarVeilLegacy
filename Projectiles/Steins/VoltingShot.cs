...
namespace LunarVeilLegacy.Projectiles.Steins
{
	public class VoltingShot : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedXa * 0, speedYa * 0, ModContent.ProjectileType<Volthit1>(), (int)(Projectile.damage * 1.5f), 0f, Projectile.owner, 0f, 0f);
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(35f * alphaCounter), (int)(45f * alphaCounter), (int)(5f * alphaCounter), 0), Projectile.rotation, new Vector2(32, 32), 0.17f * (7 + 0.6f), SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(45f * alphaCounter), (int)(55f * alphaCounter), (int)(5f * alphaCounter), 0), Projectile.rotation, new Vector2(32, 32), 0.17f * (7 + 0.6f), SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(texture2D4, Projectile.Center - Main.screenPosition, null, new Color((int)(45f * alphaCounter), (int)(45f * alphaCounter), (int)(5f * alphaCounter), 0), Projectile.rotation, new Vector2(32, 32), 0.07f * (7 + 0.6f), SpriteEffects.None, 0f);
