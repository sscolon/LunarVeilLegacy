...
namespace LunarVeilLegacy.Projectiles.Yoyo
{
	public class StarringGraftHead : ModProjectile
	{
		...
		{
			Projectile.width = 13; // The width of the projectile's hitbox.
			Projectile.height = 13; // The height of the projectile's hitbox.
		...
		public override void PostAI()
		{
			...
			{
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.YellowStarDust); // Makes the projectile emit dust.
			}
		}
		public float gh = 0;
		public override void AI()
		{
			...
			if (gh == 40)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedXa, Projectile.position.Y + speedYa, speedXa, speedYa, ModContent.ProjectileType<StarKeeperStar>(), Projectile.damage / 2, 0f, Projectile.owner, 0f, 0f);
