...
{
	public class InkingSProj2 : ModProjectile
	{
		...
		public void AttachToPlayer()
		{
			...
			if (Timer < 45)
			{
				...
				if (Main.rand.NextBool(1))
				{
					float speedXa = Main.rand.NextFloat(-60f, 60f);
					float speedYa = Main.rand.Next(-60, 60);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + speedXa, Projectile.Center.Y + speedYa, 0, 0, ModContent.ProjectileType<PaintBomb2>(), Projectile.damage, 1, Projectile.owner, 0, 0);
				}
				...
				if (Main.rand.NextBool(4))
				{
					float speedXa = Main.rand.NextFloat(-60f, 60f);
					float speedYa = Main.rand.Next(-60, 60);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + speedXa, Projectile.Center.Y + speedYa, 0, 0, ModContent.ProjectileType<PaintBomb3>(), Projectile.damage * 3, 1, Projectile.owner, 0, 0);
				...
				if (Main.rand.NextBool(4))
				{
					float speedXa = Main.rand.NextFloat(-60f, 60f);
					float speedYa = Main.rand.Next(-60, 60);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + speedXa, Projectile.Center.Y + speedYa, 0, 0, ModContent.ProjectileType<PaintBomb5>(), Projectile.damage * 3, 1, Projectile.owner, 0, 0);
					Dust.NewDustPerfect(base.Projectile.Center, ModContent.DustType<PaintBlob2>(), (Vector2.One * Main.rand.Next(1, 12)).RotatedByRandom(19.0), 0, default(Color), 4f).noGravity = false;
				}
				...
				if (Main.rand.NextBool(4))
				{
					float speedXa = Main.rand.NextFloat(-60f, 60f);
					float speedYa = Main.rand.Next(-60, 60);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + speedXa, Projectile.Center.Y + speedYa, 0, 0, ModContent.ProjectileType<PaintBomb4>(), Projectile.damage * 3, 1, Projectile.owner, 0, 0);
					Dust.NewDustPerfect(base.Projectile.Center, ModContent.DustType<PaintBlob2>(), (Vector2.One * Main.rand.Next(1, 12)).RotatedByRandom(19.0), 0, default(Color), 4f).noGravity = false;
				}
