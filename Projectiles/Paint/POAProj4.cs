...
{
    public class POAProj4 : ModProjectile, IPixelPrimitiveDrawer
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.velocity = Projectile.DirectionTo(Main.MouseWorld) * Projectile.Distance(Main.MouseWorld) / 7;
