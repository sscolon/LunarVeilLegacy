...
{
    internal class PINKX : ModProjectile,
        IPixelPrimitiveDrawer
    {
        ...
        {
            Color color = Color.Lerp(Color.HotPink, Color.HotPink, VectorHelper.Osc(0, 1));
            return color;
        }
        ...
        public void DrawPixelPrimitives(SpriteBatch spriteBatch)
        {
            ...
            TrailRegistry.LaserShader.UseColor(Color.HotPink);
