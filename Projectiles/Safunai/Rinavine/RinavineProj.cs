...
namespace LunarVeilLegacy.Projectiles.Safunai.Rinavine
{
    public class RinavineProj : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ModContent.ProjectileType<GrailShot>(), (int)(Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY * 3, ModContent.ProjectileType<GrailShot>(), (int)(Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX * 0.4f, speedY, ModContent.ProjectileType<GrailShot>(), (int)(Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
