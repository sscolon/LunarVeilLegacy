...
{
    public class MorrowWhipProj : ModProjectile
	{
		...
		{
			Vector3 RGB = new(2.92f, 1.91f, 0.84f);
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			for (int j = 0; j < 10; j++)
			{
				...
				ParticleManager.NewParticle(npc.position, speed * 7, ParticleManager.NewInstance<BurnParticle2>(), Color.RosyBrown, Main.rand.NextFloat(0.2f, 0.8f));
			}
		}
