...
namespace LunarVeilLegacy.Tiles.ShrineBreakers.Govheil
{

    public class ShrineGardenWreckerC : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<GardenWrecker>(), 1);
		}
