...
namespace LunarVeilLegacy.NPCs.Event.Gintzearmy.BossGintze
{
    ...
    public class GintziaBossBar : ModBossBar
	{
		private int GibossHeadIndex = -1;
		public override Asset<Texture2D> GetIconTexture(ref Rectangle? iconFrame)
		{
			if (GibossHeadIndex != -1)
			{
				return TextureAssets.NpcHeadBoss[GibossHeadIndex];
			}
			return null;
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, NPC npc, ref BossBarDrawParams drawParams)
		{
			...
			GibossHeadIndex = npc.GetBossHeadTextureIndex();
