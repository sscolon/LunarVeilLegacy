...
namespace LunarVeilLegacy.NPCs.Ice.WinterSouls
{
    ...
    public class WinterSoul3 : ModNPC
    {
        ...
        {
            Lighting.AddLight(NPC.Center, Color.Pink.ToVector3() * (alphaCounter / 4) * Main.essScale);
            ...
            Main.spriteBatch.Draw(texture2D5, (NPC.Center - Main.screenPosition), null, new Color((int)(35f * alphaCounter), (int)(15f * alphaCounter), (int)(55f * alphaCounter), 0), NPC.rotation, new Vector2(64 / 2, 64 / 2), 0.2f * (2 + 0.3f * 2), SpriteEffects.None, 0f);

            Main.spriteBatch.Draw(texture2D5, (NPC.Center - Main.screenPosition), null, new Color((int)(35f * alphaCounter), (int)(15f * alphaCounter), (int)(55f * alphaCounter), 0), NPC.rotation, new Vector2(64 / 2, 64 / 2), 0.2f * (4 + 0.3f * 2), SpriteEffects.None, 0f);

            Texture2D texture2D6 = ModContent.Request<Texture2D>("LunarVeilLegacy/Effects/Masks/DimLight").Value;
            Main.spriteBatch.Draw(texture2D6, (NPC.Center - Main.screenPosition), null, new Color((int)(35f * alphaCounter), (int)(15f * alphaCounter), (int)(55f * alphaCounter), 0), NPC.rotation, new Vector2(64 / 2, 64 / 2), 0.2f * (2 + 0.3f * 6), SpriteEffects.None, 0f);

            Texture2D texture2D7 = ModContent.Request<Texture2D>("LunarVeilLegacy/Effects/Masks/DimLight").Value;
            Main.spriteBatch.Draw(texture2D7, (NPC.Center - Main.screenPosition), null, new Color((int)(35f * alphaCounter), (int)(15f * alphaCounter), (int)(55f * alphaCounter), 0), NPC.rotation, new Vector2(64 / 2, 64 / 2), 0.2f * (2 + 0.3f * 7), SpriteEffects.None, 0f);
        }
    }
}