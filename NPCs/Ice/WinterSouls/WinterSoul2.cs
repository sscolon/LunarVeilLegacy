...
namespace LunarVeilLegacy.NPCs.Ice.WinterSouls
{
    ...
    public class WinterSoul2 : ModNPC
    {
        ...
        {
            Lighting.AddLight(NPC.Center, Color.DarkSeaGreen.ToVector3() * (alphaCounter / 4) * Main.essScale);
            ...
            {
                int dustnumber = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Phantasmal, 0f, 0f, 150, Color.Blue, 1f);
