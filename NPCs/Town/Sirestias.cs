	...
	public class Sirestias : ModNPC
	{
		...
		public class DelgrimPersonProfile : ITownNPCProfile
		{
			...
			public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
			{
				if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
					return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Town/Sirestias");

				if (npc.altTexture == 1)
					return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Town/Sirestias_Head");

				return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Town/Sirestias");
			}

			public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("LunarVeilLegacy/NPCs/Town/Sirestias_Head");
		}
		...
		public override void OnChatButtonClicked(bool firstButton, ref string shop)
		{
			if (!firstButton)
			{
				...
				//-----------------------------------------------------------------------------------------------
				SoundEngine.PlaySound(new SoundStyle($"LunarVeilLegacy/Assets/Sounds/Bliss1"));
