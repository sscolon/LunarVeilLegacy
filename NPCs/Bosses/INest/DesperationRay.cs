...
{
    public class DesperationRay : ModProjectile, IPixelPrimitiveDrawer
    {
        internal PrimitiveTrailCopy BeamDrawer;
        public ref float Time => ref Projectile.ai[0];
        public NPC Owner => Main.npc[(int)Projectile.ai[1]];
        public const float LaserLength = 2400f;
        // public override void SetStaticDefaults() => DisplayName.SetDefault("Desperation Ray");
        ...
        public override void AI()
        {
            ...
            Projectile.scale = MathF.Sin(Time / 80f * MathHelper.Pi) * 3f;
        ...
        public void CreateDustAtBeginning()
        {
            for (int i = 0; i < 6; i++)
            {
                Dust fire = Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(50f, 50f), DustID.CursedTorch);
