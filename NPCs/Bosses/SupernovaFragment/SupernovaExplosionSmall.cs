...
{
    public class SupernovaExplosionSmall : ModProjectile
    {
        ...
        public Color SunColorFunction(float completionRatio)
        {
            ...
            return Color.Lerp(Color.Goldenrod, Color.OrangeRed, MathF.Sin(MathHelper.Pi * completionRatio) * 0.5f + 0.3f) * Projectile.Opacity;
        }
