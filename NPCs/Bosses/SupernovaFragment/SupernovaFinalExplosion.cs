...
{
    public class SupernovaFinalExplosion : ModProjectile
    {
        ...
        public Color SunColorFunction(float completionRatio)
        {
            ...
            return Color.Lerp(Color.White, Color.White, MathF.Sin(MathHelper.Pi * completionRatio) * 0.5f + 0.3f) * Projectile.Opacity;
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            TrailRegistry.FireWhiteVertexShader.SetShaderTexture(TrailRegistry.WaterTrail);
