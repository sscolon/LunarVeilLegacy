...
{
    public class FenixSlash : ModNPC
	{
		...
		{
			NPC.frame.Width = 256;
			NPC.frame.Height = 285;
			NPC.frame.X = ((int)trueFrame % 18) * NPC.frame.Width;
			NPC.frame.Y = (((int)trueFrame - ((int)trueFrame % 18)) / 18) * NPC.frame.Height;
		}
