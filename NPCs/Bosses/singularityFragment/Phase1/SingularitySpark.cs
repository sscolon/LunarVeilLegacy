...
namespace LunarVeilLegacy.NPCs.Bosses.singularityFragment.Phase1
{
    internal class SingularitySpark : ModNPC
    {
        ...
        {
            Texture2D texture2D4 = Request<Texture2D>("LunarVeilLegacy/NPCs/Bosses/singularityFragment/Phase1/SingularitySparkFX").Value;
            Main.spriteBatch.Draw(texture2D4, NPC.Center - Main.screenPosition, null, new Color((int)(15f * alphaCounter), (int)(15f * alphaCounter), (int)(55f * alphaCounter), 0), -NPC.rotation, new Vector2(244, 244), 0.2f * (counter + 0.3f), SpriteEffects.None, 0f);
            return true;
        }
