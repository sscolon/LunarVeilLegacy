        ...
        public class GothiviaPersonProfie : ITownNPCProfile
        {
            ...
            public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
            {
                if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                    return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Bosses/GothiviaTheSun/GOS/GothiviaIdle");

                if (npc.altTexture == 1)
                    return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Bosses/GothiviaTheSun/GOS/GothiviaIdle_Head");

                return ModContent.Request<Texture2D>("LunarVeilLegacy/NPCs/Bosses/GothiviaTheSun/GOS/GothiviaIdle");
            }

            public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("LunarVeilLegacy/NPCs/Bosses/GothiviaTheSun/GOS/GothiviaIdle_Head");
        }
