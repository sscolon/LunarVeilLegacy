    ...
    public class GREENLS : ModProjectile, IPixelPrimitiveDrawer
    {
        ...
        public void CreateDustAtBeginning()
        {
            for (int i = 0; i < 6; i++)
            {
                ...
                fire.color = Color.Lerp(Color.White, Color.DarkTurquoise, Main.rand.NextFloat());
        ...
        {
            Color color = Color.Lerp(Color.MediumVioletRed, Color.Purple, 0.65f);
        ...
        public void DrawPixelPrimitives(SpriteBatch spriteBatch)
        {
            ...
            Color middleColor = Color.Lerp(Color.White, Color.SpringGreen, 0.6f);
            Color middleColor2 = Color.Lerp(Color.White, Color.Turquoise, 0.5f);
            Color finalColor = Color.Lerp(middleColor, middleColor2, Time / 120);

            TrailRegistry.GenericLaserVertexShader.UseColor(Color.SpringGreen);
            TrailRegistry.GenericLaserVertexShader.SetShaderTexture(TrailRegistry.WhispyTrail);
