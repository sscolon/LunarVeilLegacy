...
{
    internal class SunLaserProj2 : ModProjectile,
        IPixelPrimitiveDrawer
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.Center, Color.Turquoise.ToVector3() * 1.5f);
            Time++;
        }
        ...
        {
            Color color = Color.Lerp(Color.SpringGreen, Color.Turquoise, 0.2f);
