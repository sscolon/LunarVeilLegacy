...
namespace LunarVeilLegacy.NPCs.Bosses.Zui.Projectiles
{
    internal class GoldBeamWarn : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D4, NPC.Center - Main.screenPosition, null, new Color((int)(45f * alphaCounter), (int)(35f * alphaCounter), (int)(10f * alphaCounter), 0), 0, new Vector2(30 / 2, 1028 / 2), 0.2f * (counter + 0.3f), SpriteEffects.None, 0f);
            return true;
        }
