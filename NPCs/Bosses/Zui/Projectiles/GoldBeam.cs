...
{
    public class GoldBeam : ModProjectile, IPixelPrimitiveDrawer
    {
        internal PrimitiveTrailCopy BeamDrawer;
        public ref float Time => ref Projectile.ai[0];
        public NPC Owner => Main.npc[(int)Projectile.ai[1]];
        public const float LaserLength = 2400f;
        // public override void SetStaticDefaults() => DisplayName.SetDefault("Terror Beam");
        ...
        public void CreateDustAtBeginning()
        {
            for (int i = 0; i < 6; i++)
            {
                Dust fire = Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(50f, 50f), DustID.Torch);
        ...
        public void DrawPixelPrimitives(SpriteBatch spriteBatch)
        {
            ...
            TrailRegistry.GenericLaserVertexShader.UseColor(Color.LightGoldenrodYellow);
            TrailRegistry.GenericLaserVertexShader.SetShaderTexture(TrailRegistry.SpikyTrail2);
