    ...
    public class JungleRune : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if(NPC.life <= 0)
            {
                ...
                CombatText.NewText(NPC.getRect(), Color.YellowGreen, LangText.Misc("JungleRune"), true, false);
            }
        }
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            return (SpawnCondition.SurfaceJungle.Chance * SpawnRates.Rune_Spawn_Chance) + (SpawnCondition.UndergroundJungle.Chance * SpawnRates.Rune_Spawn_Chance);
        }
