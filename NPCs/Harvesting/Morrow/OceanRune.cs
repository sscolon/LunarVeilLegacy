    ...
    public class OceanRune : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if(NPC.life <= 0)
            {
                ...
                CombatText.NewText(NPC.getRect(), Color.Green, LangText.Misc("OceanRune"), true, false);
            }
        }
        ...
        {
            return SpawnCondition.Ocean.Chance * SpawnRates.Rune_Spawn_Chance * 4;
        }

        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<OceanRuneI>(), 1, 1));
        }
