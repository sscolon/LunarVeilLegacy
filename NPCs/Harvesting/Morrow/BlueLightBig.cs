...
{
    internal class BlueLightBig : ModNPC
    {
        public bool Down;
        public float Rot;
        ...
        {
            Texture2D texture2D4 = Request<Texture2D>("LunarVeilLegacy/Effects/Masks/RayLight4").Value;
            Main.spriteBatch.Draw(texture2D4, NPC.Center - Main.screenPosition, null, new Color((int)(15f * alphaCounter), (int)(35f * alphaCounter), (int)(55f * alphaCounter), 0), NPC.rotation, new Vector2(171 / 2, 51 / 2), 0.2f * (counter + 0.3f), SpriteEffects.None, 0f);
            return true;
        }
        public override void AI()
        {
            //Follow
            //1 is plugged in through the NPC.NewNPC and will be the whoAmI on projectile
            float projTarget = NPC.ai[1];
            int target = (int)projTarget;
            Projectile projectile = Main.projectile[target];
