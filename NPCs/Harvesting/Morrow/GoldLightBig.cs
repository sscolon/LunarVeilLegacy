...
{
    internal class GoldLightBig : ModNPC
    {
        public bool Down;
        public float Rot;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D4, NPC.Center - Main.screenPosition, null, new Color((int)(15f * alphaCounter), (int)(55f * alphaCounter), (int)(35f * alphaCounter), 0), NPC.rotation, new Vector2(171 / 2, 51 / 2), 0.2f * (counter + 0.3f), SpriteEffects.None, 0f);
            return true;
        }
