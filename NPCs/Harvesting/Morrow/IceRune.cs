    ...
    public class IceRune : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if(NPC.life <= 0)
            {
                ...
                CombatText.NewText(NPC.getRect(), Color.LightBlue, LangText.Misc("IceRune"), true, false);
            }
        }
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[1] >= 40)
            {
                if (Main.rand.NextBool(9))
                {
                    ...
                    NPC.NewNPC(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<OceanRuneLightBig>());
                }
            }
            NPC.damage = 0;
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            {
                return 
                    (SpawnCondition.Overworld.Chance * SpawnRates.Rune_Spawn_Chance) +
                    (SpawnCondition.Cavern.Chance * SpawnRates.Rune_Spawn_Chance) + 
                    (SpawnCondition.Underground.Chance * SpawnRates.Rune_Spawn_Chance);
            }
