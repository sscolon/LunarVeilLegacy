    ...
    public class StarbloomSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (minPillarDepth != -1)
            {
                ...
                for (int i = minPillarDepth; i < maxPillarDepth; i++)
                {
                    ...
                    if (rectangle.Contains((int)PillarPosition.X, (int)PillarPosition.Y))
                    {
                        ...
                        Texture2D BeamTexture = ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/StarbloomSkyBeam").Value;
            ...
            if (minBGPillarDepth != -1)
            {
                ...
                for (int i = minBGPillarDepth + 1; i < maxBGPillarDepth; i++)
                {
                    ...
                    if (rectangle.Contains((int)position.X, (int)position.Y) && position.Y > -750)
                    {
                        ...
                        Texture2D BeamTextureTop = ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/StarbloomSkyBeam").Value;
                        Texture2D BeamTextureBottom = ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/StarbloomSkyBeam2").Value;
            ...
            if (maxDepth >= 3.40282347E+38f && minDepth < 3.40282347E+38f)
            {
                ...
                Texture2D SkyTexture = ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/StarbloomSkyBeam").Value;
