...
{
	public class VillageSky : CustomSky
	{
		...
		public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
		{
			...
			if (maxDepth >= 2 && minDepth < 2)
			{
				...
				storm.Parameters["uTexture0"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/CloudNoise").Value);
				storm.Parameters["uTexture1"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/Noise7").Value);
				...
				storm.Parameters["uTime"].SetValue(_windSpeed / 3f);
				storm.Parameters["uCurveFactor"].SetValue(1.2f);
				storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/ColorMap5").Value);
