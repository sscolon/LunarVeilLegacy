    ...
    public class NaxtrinSky : CustomSky
	{
		...
		public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
		{
			...
			if (maxDepth >= 2 && minDepth < 2)
			{
				...
				storm.Parameters["uTexture0"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/Noise1").Value);
				storm.Parameters["uTexture1"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/Noise2").Value);
				...
				storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/ColorMap").Value);
