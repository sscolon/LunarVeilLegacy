    ...
    public class NaxtrinSky2 : CustomSky
	{
		...
		public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
		{
			...
			if (maxDepth >= 2 && minDepth < 2)
			{
				...
				storm.Parameters["uTexture1"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/CloudNoise").Value);
				...
				storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/ColorMap8").Value);
			...
			if (maxDepth >= 2 && minDepth < 2)
			{
				...
				storm.Parameters["uColorMap"].SetValue(ModContent.Request<Texture2D>("LunarVeilLegacy/Textures/ColorMap6").Value);
				storm.Parameters["uColorMapSection"].SetValue(0.2f);
