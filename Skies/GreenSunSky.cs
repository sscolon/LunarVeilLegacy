    ...
    public class GreenSunSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (maxDepth >= 3.40282347E+38f && minDepth < 3.40282347E+38f)
            {
                ...
                for (int i = 0; i < 2; i++)
                    spriteBatch.Draw(Tex2, new Rectangle(0, -30, screenWidth, screenHeight), null, Color.Orange * Intensity * 0.7f, 0, Vector2.Zero, SpriteEffects.None, 0);
            }
            else
            {
            }
        ...
        public override Color OnTileColor(Color inColor)
        {
            ...
            return new Color(Vector4.Lerp(value, Vector4.One, Intensity * 0.7f));
        }
    }
}